    ...
    for (let prop in product) {
        for (i = 0; i < product[prop].length; i++) {
            ...
            if (product[prop][i]["company"]) {
                if (product[prop][i]["company"]["companyName"] === "" || product[prop][i]["company"]["date"] == "" || product[prop][i]["company"]["companyName"] == "") {
                    html += "<td>" + "Not Available" + "</td>";
                    html += "<td>" + "Not Available" + "</td>";
                    html += "<td>" + "Not Available" + "</td>";
                }
...
function addProduct() {
    ...
    if (companyName == "" || companyName == " " || companyDate == "" || companyDate == " " || address == "" || address == " ") {
        companyName = "Not Available";
        companyDate = "Not Available";
...
function saveButton(id) {
    ...
    message("", "");
    let productId = document.getElementById("productId").value;
    let newPartNumber = document.getElementById("partNumber").value;
...
function sortByDateFunction() {
    ...
    for (let i = 0; i < companyDates1.length; i++) {
        for (let key in product) {
            for (let j = 0; j < product[key].length; j++) {
                if (!product[key][j].company) {
                    if (product[key][j].id === companyDates1[i].id) {
                        sortedProducts1.push(product[key][j]);
                    }
                }
            }
        }
    ...
    sortedDataShow(sortedProducts , sortedProducts1);
}
...
function sortByNameFunction() {
    ...
    for (let i = 0; i < companyNames1.length; i++) {
        for (let key in product) {
            for (let j = 0; j < product[key].length; j++) {
                if (!product[key][j].company) {
                    if (product[key][j].id == companyNames1[i].id) {
                        sortedProducts1.push(product[key][j]);
                    }
                }
            }
...
/* SORTED DATA SHOW */
function sortedDataShow(sortedProducts, sortedProducts1) {
    let mainTable = document.getElementById("mainTable");
    html = "";
    html += "<tr>";
    html += "<th>ID</th>";
    ...
    for (let i = 0; i < sortedProducts1.length; i++) {
        html += "<tr>";
        html += "<td>" + sortedProducts1[i].id + "</td>";
        html += "<td>" + sortedProducts1[i].partNumber + "</td>";
        html += "<td>" + sortedProducts1[i].name + "</td>";
        html += "<td>" + sortedProducts1[i].size + "</td>";
        html += "<td>" + sortedProducts1[i].colors + "</td>";
        if (sortedProducts1[i].weight) {
            html += "<td>" + sortedProducts1[i].weight + "</td>";
        }
        if (!sortedProducts1[i].weight) {
            html += "<td>" + "Not Available" + "</td>";
        }
        html += "<td>" + sortedProducts1[i].description + "</td>";
        html += "<td>" + "Not Available" + "</td>";
        html += "<td>" + "Not Available" + "</td>";
        html += "<td>" + "Not Available" + "</td>";
        html += "<td><button id= 'actionButton' onclick=\"modifyButton(" + sortedProducts1[i].id + ")\">Modify</button><button id= 'actionButton' onclick=\"propertyButton(" + sortedProducts1[i].id + ")\">Check property</button><button id= 'actionButton' onclick=\"saveButton(" + sortedProducts1[i].id + ")\">Save</button><button id= 'actionButton' onclick=\"deleteButton(" + sortedProducts1[i].id + ")\">Delete</button></td>";
        html += "</tr>";
    }
